...
exports.postgresOptions = {
    port: 7142,
    host: (_a = process.env.PGHOST) !== null && _a !== void 0 ? _a : "",
    database: (_b = process.env.PGDATABASE) !== null && _b !== void 0 ? _b : "",
    user: (_c = process.env.PGUSER) !== null && _c !== void 0 ? _c : "",
    password: (_d = process.env.PGPASSWORD) !== null && _d !== void 0 ? _d : "",
};
